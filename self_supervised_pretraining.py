...
if __name__ == "__main__":
    ...
    for split in range(1, kfold+1):
        for seed in range(0, train_repeat):
            ...
            bash += ' python do_train_jigsaw.py --method_name cfn --sample_strategy original --input_h 225 --input_w 225 --batch_size 256' + code_list[0]
            ...
            bash += ' --split {} --seed {}'.format(split, seed)
            os.system(bash)