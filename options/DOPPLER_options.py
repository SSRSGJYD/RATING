...
class DOPPLEROptions(object):
    @staticmethod
    def modify_commandline_options(parser):
        # basic parameters
        parser.add_argument('--name', type=str, default='DOPPLER', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--split', type=int, default=1)
        parser.add_argument('--expid', type=int, default=1)
        parser.add_argument('--checkpoints_dir', type=str, default=config.DOPPLER_checkpoints, help='models are saved here')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='DOPPLER', help='chooses train dataset')
        ...
        parser.add_argument('--v_dataset_mode', type=str, default='DOPPLER', help='chooses valid dataset')
        ...
        parser.add_argument('--classes', type=str, default='01,23')
        parser.add_argument('--label', type=str, default='DOPPLER', choices=('GS', 'DOPPLER', 'combined'))

        parser.add_argument('--data_norm_type', type=str, default='imagenet')
        parser.add_argument('--policy', type=str, default='roi_random')
