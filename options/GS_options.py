...
class GSOptions(object):
    @staticmethod
    def modify_commandline_options(parser):
        # basic parameters
        parser.add_argument('--name', type=str, default='GS', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--split', type=int, default=1)
        parser.add_argument('--expid', type=int, default=1)
        parser.add_argument('--checkpoints_dir', type=str, default=config.GS_checkpoints, help='models are saved here')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='GS', help='chooses train dataset')
        ...
        parser.add_argument('--v_dataset_mode', type=str, default='GS', help='chooses valid dataset')
